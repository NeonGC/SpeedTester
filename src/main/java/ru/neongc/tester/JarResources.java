...
public final class JarResources {
    ...
    private final Hashtable<Object, Object> htSizes = new Hashtable<>();
    private final Hashtable<Object, Object> htJarContents = new Hashtable<>();
    ...
    private void init() {
        try {
            ...
            while ((ze = zis.getNextEntry()) != null) {
                ...
                int rb = 0;
                while ((size - rb) > 0) {
                    int chunk = zis.read(b, rb, size - rb);
                    if (chunk == -1) {
                        break;
                    }
                    rb += chunk;
